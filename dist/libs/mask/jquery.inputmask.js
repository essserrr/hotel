        ...
        (modules = [
                    ...
                    isValid: function isValid(value) {
                        ...
                        for (
                            var buffer = _positioning.getBuffer.call(this),
                                rl = _positioning.determineLastRequiredPosition.call(
                                    this
                                ),
            ...
            function (module, exports, __webpack_require__) {
                ...
                function isMask(pos, strict, fuzzy) {
                    var inputmask = this,
                        maskset = this.maskset,
                        test = _validationTests.getTestTemplate.call(this, pos)
                            .match;
                    if (
                        ("" === test.def &&
                            (test = _validationTests.getTest.call(this, pos)
                                .match),
                        !0 !== test.static)
                    )
                        return test.fn;
            ...
            function (module, exports, __webpack_require__) {
                ...
                function isComplete(buffer) {
                    ...
                    if ("*" !== opts.repeat) {
                        var complete = !1,
                            lrp = _positioning.determineLastRequiredPosition.call(
                                this,
                                !0
                            ),
                        ...
                        if (
                            ...
                            complete = !0;
                            for (var i = 0; i <= aml; i++) {
                                var test = _validationTests.getTestTemplate.call(
                                    this,
                                    i
                                ).match;
                                if (
                    ...
                    keypressEvent: function keypressEvent(
                        ...
                        if (k) {
                            ...
                            if (
                                ...
                                var buffer = _positioning.getBuffer.call(
                                    inputmask
                                );
                                (0, _inputHandling.writeBuffer)(
                                    input,
            ...
            function (module, exports, __webpack_require__) {
                ...
                function analyseMask(maskString, format, opts) {
                    ...
                    function setValue(dateObj, value, opts) {
                        if (
                            ((dateObj[targetProp] = value.replace(
                                /[^0-9]/g,
                                "0"
                            )),
